  ...
  return (
    <div className='min-h-screen p-4' style={{backgroundColor:"#e1b382"}}>
        ...
        <div className='flex justify-evenly p-4'>
          ...
          <div className='w-1/3 border-black border-2 rounded-md p-4 '>
          ...
          <div className='p-2 '>
            <input type='text' value={msg} onChange={(e)=>setMsg(e.target.value)} className='p-2 border-2 border-black'/>
            <button onClick={sendMessage} className='p-2 w-14 bg-blue-400 rounded-md text-white hover:bg-blue-500'>Send</button>
          </div>
